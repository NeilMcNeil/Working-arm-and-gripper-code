...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if (gripper > 0) {
      r4.set(ControlMode.PercentOutput, gripper/2);
    }
    if (gripper == 0) {
    ...
    if (gripper2 < 0) {
      r4.set(ControlMode.PercentOutput, gripper2/2);
    } 
    ...
    if (motion < 0) {
      l4.set(ControlMode.PercentOutput, motion/2);
    }
    if (motion == 0) {
    ...
    if (motion2 > 0) {
      l4.set(ControlMode.PercentOutput, motion2/2);
    }
    if (motion2 == 0) {
      l4.set(ControlMode.PercentOutput, 0);
    }
